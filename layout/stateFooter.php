            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-sm hover:text-white transition">Services</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition">Projects</a></li>
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-sm hover:text-white transition">Documentation</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition">FAQ</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition">Support</a></li>
                    </ul>
                </div>

                <div class="space-y-4">
                    <h3 class="text-white text-lg font-semibold">Connect</h3>
                    <div class="flex space-x-4">
                        ...
                        <a href="https://github.com/YassineElHassani" class="text-gray-400 hover:text-white transition">
